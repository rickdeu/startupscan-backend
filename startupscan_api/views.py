...
class InvestorInterestCreateView(RoleRequiredMixin, View):
    """Investidor demonstra interesse em conectar com empreendedor da análise."""
    ...
    def post(self, request, analysis_id):
        ...
        if not analysis.user_id:
            messages.error(
                request,
                "Esta análise não possui empreendedor associado para conexão no momento.",
            )
            return _redirect_back_or_default(request, "investor_dashboard")
...
class ConnectionInterestUpdateView(RoleRequiredMixin, View):
    """Atualiza status da conexão entre investidor e empreendedor."""
...
class ConnectionsHubView(RoleRequiredMixin, View):
    """Página de fluxo de conexão entre investidores e empreendedores."""
    ...
    def get(self, request):
        ...
        return render(request, "analyzer/connections_hub.html", context)
