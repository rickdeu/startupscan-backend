...
PLANS = [
    {
        ...
        'batch_max_rows': 0,
        # Trial mirrors full Pro-level engine access while it lasts.
        'local_analysis': True,
        'gpt_analysis': True,
    ...
    },
    {
        ...
        'trial_days': 0,
        'is_active': True,
        # Plan a trial subscription is lazily downgraded to once it expires
        # without converting to a paid plan (see subscriptions/mixins.py).
        'analyses_per_month': 3,
        'videos_per_month': 0,
        'investor_interests_per_month': 0,
        'batch_max_rows': 0,
